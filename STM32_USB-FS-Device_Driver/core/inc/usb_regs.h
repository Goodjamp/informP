...
/* Control register */
#define CNTR    ((__IO uint32_t *)(RegBase + 0x40))
/* Interrupt status register */
#define ISTR    ((__IO uint32_t *)(RegBase + 0x44))
/* Frame number register */
#define FNR     ((__IO uint32_t *)(RegBase + 0x48))
/* Device address register */
#define DADDR   ((__IO uint32_t *)(RegBase + 0x4C))
/* Buffer Table address register */
#define BTABLE  ((__IO uint32_t *)(RegBase + 0x50))
/******************************************************************************/
/*                         Endpoint registers                                 */
/******************************************************************************/
#define EP0REG  ((__IO uint32_t *)(RegBase)) /* endpoint 0 register address */
