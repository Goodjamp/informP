...
#define DEFAULT_CONFIG_DESCRIPTION                                                                 \
    .s_config_moduls.s_connectmodbus_global[0].state                      = DISABLE,               \
    ...
    .s_config_moduls.s_connectmodbus_global[0].s_port_config.amountBit    = 8,                     \
...
/*  Bit #     Paramiter             */\
    ...
    .s_config_moduls.s_display_user_config.numScreen                      = 4,                     \
                                                                                                   \
    .s_config_moduls.s_display_user_config.screenConfig[0].numParamiterPerScreen = 14,             \
    .s_config_moduls.s_display_user_config.screenConfig[0].bitsOfParamiters      = 0b11111111111111,\
                                                                                                   \
    .s_config_moduls.s_display_user_config.screenConfig[1].numParamiterPerScreen = 14,             \
    .s_config_moduls.s_display_user_config.screenConfig[1].bitsOfParamiters      = 0b11111111111111,\
                                                                                                   \
    .s_config_moduls.s_display_user_config.screenConfig[2].numParamiterPerScreen = 14,             \
    .s_config_moduls.s_display_user_config.screenConfig[2].bitsOfParamiters      = 0b11111111111111,\
                                                                                                   \
    .s_config_moduls.s_display_user_config.screenConfig[3].numParamiterPerScreen = 14,             \
    .s_config_moduls.s_display_user_config.screenConfig[3].bitsOfParamiters      = 0b11111111111111,\
    /*==========default BUI configuration========*/\
    .s_config_moduls.s_bui_user_config.state = ENABLE,                     \
    .s_config_moduls.s_bui_user_config.baudrate = 9600,                      \
    .s_config_moduls.s_bui_user_config.parity = 0,                          \
    .s_config_moduls.s_bui_user_config.address = 1
